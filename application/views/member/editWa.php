<?php
    ...
    include APPPATH . 'views/fragment/sidebarWa.php' ;
        ...
        <div class="card shadow-sm mb-4 border-bottom-primary">
            <div class="card-header bg-white py-3">
                <div class="row">
                    ...
                    <div class="col-auto">
                        <a href="<?= base_url('member/dashboardNomor') ?>" class="btn btn-sm btn-secondary btn-icon-split">
                            <span class="icon">
            ...
            <div class="card-body pb-2">
                ...
                <?php echo form_open_multipart('member/edit_member_wa'); ?>
